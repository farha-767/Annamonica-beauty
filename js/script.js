(function () {
    ...
    window.addEventListener('scroll', function() {
        var imagea = document.getElementById('myImage-logo');
        var scrollPosition = window.scrollY;
      
        // Check if scroll position is greater than a certain value
        if (scrollPosition > 10) {
          imagea.src = 'images/logo.png';
        } else {
          imagea.src = 'images/logo-white.png';
        }
      });
      ...
      $('#about-nav').click(function() {
        if ($(window).width() < 768) {
          ...
          var isExpanded = navbarCollapse.hasClass('show');
          navbarToggler.attr('aria-expanded', isExpanded ? 'true' : 'false');
        }
      });


      $('#contact-a-nav').click(function() {
        if ($(window).width() < 768) {
          var navbarToggler = $('.navbar-toggler');
          var navbarCollapse = $('.navbar-collapse');
